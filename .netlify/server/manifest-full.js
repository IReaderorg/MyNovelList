	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/v1/novels/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/v1/novels/search/_server.ts.js'))
			},
			{
				id: "/api/v1/novels/[id]",
				pattern: /^\/api\/v1\/novels\/([^/]+?)\/?$/,
				...
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/v1/novels/_id_/_server.ts.js'))
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/v1/novels/_id_/progress/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/v1/tier-lists/_server.ts.js'))
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/v1/tier-lists/_id_/_server.ts.js'))
			},
			{
